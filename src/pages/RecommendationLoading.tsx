...
const FACTS = [
  ...
  'KyaDekhu narrows that down to a perfect match in under 30 seconds.',
      ...
      <div className="relative z-10 max-w-sm w-full">
        ...
        <div className="relative w-28 h-28 mx-auto mb-10">
          ...
          <motion.div
            ...
            style={{
              background: 'conic-gradient(from 0deg, transparent 0%, rgba(139,92,246,1) 20%, transparent 40%)',
            }}
            animate={{ rotate: 360 }}
          ...
          <motion.div
            ...
            style={{
              background: 'conic-gradient(from 120deg, transparent 0%, rgba(167,139,250,0.8) 15%, transparent 35%)',
            }}
            animate={{ rotate: -360 }}
          ...
          <div className="absolute inset-6 rounded-full bg-[#0b0814] border border-white/[0.08] flex items-center justify-center">
            ...
            return (
              <motion.div
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all duration-300 ${
                  active
                    ? 'bg-accent/10 border-accent/25 shadow-[0_4px_15px_rgba(139,92,246,0.1)]'
                    : done
              ...
              >
                <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 border transition-all duration-300 ${
                  done ? 'bg-accent border-accent shadow-[0_0_10px_rgba(139,92,246,0.4)]'
