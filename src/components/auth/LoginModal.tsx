...
import { X, Mail, Phone, ArrowRight, ShieldCheck, Film, Eye, EyeOff, Check, Loader2, User } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-[820px] h-[550px] bg-[#050505] border border-white/[0.08] rounded-[32px] overflow-hidden flex shadow-[0_24px_80px_rgba(0,0,0,0.9),0_0_40px_rgba(139,92,246,0.08)] z-10"
        >
          {/* Close button */}
          <button
            onClick={() => { closeLoginModal(); resetState(); }}
            className="absolute top-5 right-5 z-50 p-2.5 rounded-full bg-black/50 text-muted-foreground hover:text-white border border-white/[0.08] hover:bg-white/[0.08] transition-all duration-200"
          >
            <X className="w-4 h-4" />
          </button>
              ...
              {step === 'success' && (
                ...
                >
                  <motion.div
                    ...
                    className="w-16 h-16 rounded-full bg-emerald-500/20 border-2 border-emerald-500/40 flex items-center justify-center mb-5 shadow-[0_0_20px_rgba(16,185,129,0.2)]"
                  >
                    <Check className="w-8 h-8 text-emerald-400" />
                  </motion.div>
                  <h3 className="text-xl font-bold text-white mb-2">Welcome back!</h3>
                  <p className="text-[13px] text-muted-foreground">You're signed in. Redirecting…</p>
                </motion.div>
              )}
              ...
              {step === 'forgot' && (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <div className="w-14 h-14 rounded-[20px] bg-[#8B5CF6]/10 border border-[#8B5CF6]/20 flex items-center justify-center mb-4">
                      <Mail className="w-6 h-6 text-[#8B5CF6]" />
                    </div>
                    <h3 className="text-lg font-bold text-white">Check your inbox</h3>
                    <p className="text-[13.5px] text-muted-foreground mt-1.5 max-w-xs">
                      We've sent a password reset link to <span className="text-white font-semibold">{email || 'your email'}</span>
                    </p>
                  </div>
                  <button
                    onClick={() => setStep('signin')}
                    className="w-full h-11 rounded-[14px] bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] text-[13px] font-semibold text-white transition-all duration-200"
                  >
                    ← Back to Sign In
                  </button>
                </motion.div>
                ...
                >
                  ...
                  <form onSubmit={handleVerifyOTP} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full h-11 rounded-[14px] text-[13.5px] font-bold text-white flex items-center justify-center gap-2 transition-all disabled:opacity-40 disabled:cursor-not-allowed overflow-hidden bg-[#8B5CF6] hover:bg-[#8B5CF6]/90 shadow-[0_4px_20px_rgba(139,92,246,0.25)]"
                    >
                      {isSubmitting ? (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-[12px] text-[#8B5CF6] hover:text-white transition-colors font-semibold">
                      Resend Code
                    </button>
                  </div>
                </motion.div>
              ...
              {(step === 'signin' || step === 'signup') && (
                ...
                >
                  ...
                  <form onSubmit={handleSendOTP} className="space-y-3.5">
                    ...
                    {step === 'signup' && (
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className={`w-full h-11 px-3.5 rounded-[12px] bg-white/[0.03] border text-[13.5px] text-white placeholder-white/20 focus:outline-none focus:border-[#8B5CF6]/50 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(139,92,246,0.15)] transition-all ${
                            errors.name ? 'border-[#FF3B30]/50 bg-[#FF3B30]/5' : 'border-white/[0.08]'
                          }`}
                        />
                        {errors.name && <p className="text-[10px] text-[#FF3B30] font-medium">{errors.name}</p>}
                      </div>
                    )}
                    ...
                    {activeTab === 'email' ? (
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className={`w-full h-11 px-3.5 rounded-[12px] bg-white/[0.03] border text-[13.5px] text-white placeholder-white/20 focus:outline-none focus:border-[#8B5CF6]/50 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(139,92,246,0.15)] transition-all ${
                            errors.email ? 'border-[#FF3B30]/50 bg-[#FF3B30]/5' : 'border-white/[0.08]'
                          }`}
                        />
                        {errors.email && <p className="text-[10px] text-[#FF3B30] font-medium">{errors.email}</p>}
                      </div>
                    ) : (
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className={`w-full h-11 px-3.5 rounded-[12px] bg-white/[0.03] border text-[13.5px] text-white placeholder-white/20 focus:outline-none focus:border-[#8B5CF6]/50 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(139,92,246,0.15)] transition-all ${
                            errors.phone ? 'border-[#FF3B30]/50 bg-[#FF3B30]/5' : 'border-white/[0.08]'
                          }`}
                        />
                        {errors.phone && <p className="text-[10px] text-[#FF3B30] font-medium">{errors.phone}</p>}
                      </div>
                    )}
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full h-11 px-3.5 pr-10 rounded-[12px] bg-white/[0.03] border text-[13.5px] text-white placeholder-white/20 focus:outline-none focus:border-[#8B5CF6]/50 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(139,92,246,0.15)] transition-all ${
                              errors.password ? 'border-[#FF3B30]/50 bg-[#FF3B30]/5' : 'border-white/[0.08]'
                            }`}
                          />
                          <button
                            type="button"
                        ...
                        {errors.password && <p className="text-[10px] text-[#FF3B30] font-medium">{errors.password}</p>}
                      </div>
                    )}
                        ...
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <div
                            ...
                            className={`w-4 h-4 rounded border transition-all flex items-center justify-center ${
                              rememberMe ? 'bg-[#8B5CF6] border-[#8B5CF6]' : 'border-white/20 bg-white/5 group-hover:border-white/30'
                            }`}
                          >
                            {rememberMe && <Check className="w-2.5 h-2.5 text-white" />}
                          </div>
                          <span className="text-[11.5px] text-muted-foreground group-hover:text-white transition-colors">Remember me</span>
                        </label>
                        <button
                          type="button"
                          onClick={handleForgotPassword}
                          className="text-[11.5px] text-[#8B5CF6] hover:text-white transition-colors font-semibold"
                        >
                          Forgot password?
                        </button>
                      </div>
                    ...
                    <button
                      type="submit"
                      className="w-full h-11 rounded-[14px] text-[13.5px] font-bold text-white flex items-center justify-center gap-2 group transition-all overflow-hidden bg-[#8B5CF6] hover:bg-[#8B5CF6]/90 shadow-[0_4px_20px_rgba(139,92,246,0.25)]"
                    >
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    <button
                      ...
                      className="h-10 rounded-[12px] bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/15 text-[12px] font-bold text-white flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                    >
