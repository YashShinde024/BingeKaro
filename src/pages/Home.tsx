...
const HERO = MOVIES[0]; // Dune: Part Two
...
const Section: React.FC<SectionProps> = ({ title, subtitle, badge, children, viewAllTo }) => (
  ...
  >
    ...
    <div className="flex gap-4 scroll-row px-6 lg:px-10 pb-2">
      {children}
    </div>
  </motion.section>
);
    ...
    <div className="min-h-screen bg-[#080808]">
      ...
      <div ref={heroRef} className="relative h-[100svh] min-h-[600px] overflow-hidden">
        ...
        <motion.div className="absolute inset-0" style={{ y: heroY }}>
          <img
            src={imgError ? FALLBACK_BG : HERO.backdropPath}
            alt={HERO.title}
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[rgba(8,8,8,0.75)] via-transparent to-transparent" />
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-accent/25
                           bg-accent/10 backdrop-blur-sm mb-6 animate-pulse"
              >
              ...
              <p className="text-[16px] sm:text-[18px] text-white/65 mb-8 max-w-[480px] leading-relaxed font-light">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Link to="/discover">
                  <motion.div
                    ...
                    style={{ boxShadow: '0 8px 32px rgba(139,92,246,0.4), 0 0 0 1px rgba(139,92,246,0.3)' }}
                  >
                ...
                >
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 text-white/80 font-semibold
                               ...
                               hover:border-white/25 hover:bg-white/[0.06] transition-all duration-200 select-none"
                  >
            ...
            >
              <Link to={`/movie/${HERO.id}`}>
                <motion.div
                  ...
                  className="glass-card rounded-2xl p-4 w-[260px] cursor-pointer border border-white/[0.08]"
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[13px] font-semibold text-white leading-tight mt-0.5">{HERO.title}</p>
                    </div>
                  </div>
        ...
        <Link to={`/movie/${TONIGHT.id}`}>
          ...
          >
            ...
            <div className="relative h-52 sm:h-72">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[rgba(8,8,8,0.95)] via-[rgba(8,8,8,0.6)] to-[rgba(8,8,8,0.2)]" />
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(8,8,8,0.8)] to-transparent" />
            </div>
            ...
            <div className="absolute inset-0 flex items-end p-6 sm:p-8">
              <div className="max-w-lg">
                ...
                <p className="text-[13px] text-white/65 line-clamp-2 mb-4 max-w-md">
                  {TONIGHT.aiInsight}
                </p>
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[13px] text-white/60">{TONIGHT.year}</span>
                  <span className="w-1 h-1 bg-white/30 rounded-full" />
      ...
      <div className="max-w-[1400px] mx-auto" id="trending-section">
        ...
        {continueWatching && continueWatching.length > 0 && (
          <Section
            ...
            badge={<Clock className="w-4.5 h-4.5 text-accent-light" />}
          >
        ...
        <section className="mb-14 px-6 lg:px-10">
          <div className="relative rounded-3xl overflow-hidden bg-[#0f0a1e] border border-accent/15"
            ...
            <div className="relative p-8 sm:p-10">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 bg-accent/20 rounded-xl flex items-center justify-center border border-accent/30 animate-pulse">
              ...
              <div className="flex gap-4 scroll-row pb-2">
