...
export const About: React.FC = () => (
  <div className="min-h-screen bg-[#07111F] pt-24 pb-24 md:pb-16 relative overflow-hidden">
    ...
    <div className="relative max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
      ...
      <FadeIn className="mb-14">
        ...
        <p className="text-white/55 text-[17px] leading-relaxed max-w-xl">
          BingeKaro started from a simple frustration — spending 45 minutes looking for something to watch,
        ...
        {[
          {
            label: 'Mission',
            icon: Zap,
            text: 'Help every user find something worth watching instantly, using AI that actually understands mood and context.',
          },
          {
            label: 'Vision',
            icon: Globe,
      ...
      <FadeIn delay={0.2} className="mb-14">
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(255,23,68,0.1) 0%, rgba(213,0,0,0.06) 100%)',
        ...
        >
          ...
          <p className="text-white text-[17px] font-semibold leading-relaxed">
            "Netflix paradox" is real — more content, less satisfaction. We're solving decision fatigue for 500M+ Indian streaming subscribers.
          </p>
        </div>
      </FadeIn>
      ...
      <FadeIn delay={0.5}>
        <div className="glass rounded-2xl p-7 border border-white/[0.07] text-center mb-8">
          ...
          <p className="text-white/50 text-[13px] max-w-md mx-auto leading-relaxed">
            BingeKaro is built and maintained by Nyxen — a collective building intelligent, beautifully designed products.
          </p>
        </div>
      </FadeIn>
    ...
    <div className="min-h-screen bg-[#07111F] pt-24 pb-24 md:pb-16 relative overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-5 sm:px-6 lg:px-8">
        <FadeIn className="mb-10">
          ...
          <p className="text-white/55 text-[16px]">Questions, feedback, or partnerships — we read everything.</p>
        </FadeIn>
        ...
        <AnimatePresence mode="wait">
          {sent ? (
            <motion.div
              ...
              style={{ boxShadow: '0 0 60px rgba(255,23,68,0.08)' }}
            >
              <motion.div
            ...
            >
              ...
              >
                {[
                  ...
                  <div key={field.id}>
                    ...
                    <input
                      ...
                      style={{
                        borderColor: focusedField === field.id ? 'rgba(255,23,68,0.5)' : 'rgba(255,255,255,0.08)',
                        boxShadow: focusedField === field.id ? '0 0 0 3px rgba(255,23,68,0.08)' : 'none',
                      }}
                    />
                  </div>
                ))}
                <div>
                  ...
                  <textarea
                    ...
                    style={{
                      borderColor: focusedField === 'msg' ? 'rgba(255,23,68,0.5)' : 'rgba(255,255,255,0.08)',
                      boxShadow: focusedField === 'msg' ? '0 0 0 3px rgba(255,23,68,0.08)' : 'none',
                    }}
                  />
                </div>
                <motion.button
                  ...
                  style={{ boxShadow: '0 6px 24px rgba(255,23,68,0.4)' }}
                >
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    { q: 'Is BingeKaro free to use?', a: 'Yes, completely free. We never charge for recommendations.' },
                    { q: 'Does BingeKaro have a mobile app?', a: 'A mobile app is on our roadmap for 2026.' },
...
const LegalPage: React.FC<{ title: string; sections: { heading: string; content: string }[] }> = ({ title, sections }) => (
  <div className="min-h-screen bg-[#07111F] pt-24 pb-24 md:pb-16">
    ...
    sections={[
      {
        ...
        content: 'BingeKaro collects minimal data: your watch preferences, saved titles, and recommendation history. We do not sell your data to third parties under any circumstances.',
      },
      {
    ...
    sections={[
      {
        ...
        content: 'By using BingeKaro, you agree to these terms. If you do not agree, please do not use the service.',
      },
      {
        heading: 'Service Description',
        content: 'BingeKaro provides AI-powered entertainment discovery and OTT streaming availability information. We do not host, stream, or distribute any content.',
      },
      {
      ...
      },
      {
        ...
        content: 'BingeKaro and Nyxen are not liable for any direct or indirect damages arising from use of the service. The service is provided as-is.',
      },
    ]}
  />
);
