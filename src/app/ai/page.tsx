    ...
    <div className="min-h-screen bg-[#050505] pt-24 pb-28">
      <div className="max-w-[800px] mx-auto px-6 lg:px-10 space-y-8">
        ...
        <div className="flex items-center gap-3.5 pb-6 border-b border-white/[0.05]">
          <div className="w-12 h-12 rounded-2xl bg-[#8B5CF6]/10 border border-[#8B5CF6]/20 flex items-center justify-center text-[#8B5CF6] shadow-[0_0_20px_rgba(139,92,246,0.3)] animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <motion.div
              ...
              className="bg-white/[0.02] border border-white/[0.05] hover:border-[#8B5CF6]/30 hover:shadow-[0_12px_40px_rgba(139,92,246,0.06)] rounded-[24px] p-6 flex flex-col justify-between min-h-[160px] transition-all duration-300 cursor-pointer"
            >
              <div className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-[#8B5CF6] mb-4">
